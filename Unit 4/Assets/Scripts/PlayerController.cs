...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float forwardInput = Input.GetAxis("Vertical"); // gets input of the user when the user pushes the up/down arrow button
        
        playerRb.AddForce(focalPoint.transform.forward * speed * forwardInput ); // makes the player go forward and backwards
